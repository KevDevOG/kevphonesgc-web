...
export default async function VenderPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#050506] pb-20 md:pb-0 selection:bg-purple-500/30">
      <PublicHeader />
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-4 py-6 md:py-8">
        <SellDeviceForm 
          models={typedModels} 
